...
package de.linusdev.cvg4j.engine.cl.structs;
...
public class CameraStruct extends ComplexStructure {
    ...
    @StructValue public final @NotNull BBFloat3 position = BBFloat3.newUnallocated();
    @StructValue public final @NotNull BBFloat3 lookAtVector = BBFloat3.newUnallocated();
    @StructValue public final @NotNull BBFloat1 distanceToScreen = BBFloat1.newUnallocated();
