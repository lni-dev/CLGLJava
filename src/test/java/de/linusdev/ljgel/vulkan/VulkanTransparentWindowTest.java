...
import de.linusdev.ljgel.nat.vulkan.utils.VulkanVersionUtils;
...
import static de.linusdev.ljgel.engine.vk.shader.VulkanSpirVUtils.createShaderModuleInfo;
import static de.linusdev.ljgel.nat.vulkan.utils.VulkanNonInstanceMethods.vkCreateInstance;
    ...
    void test() throws GLFWException, IOException {
        ...
        vkInstance.vkCreateShaderModule(
                ...
                TypedPointer64.of(createShaderModuleInfo(
                        ...
                        getClass().getResourceAsStream("/de/linusdev/ljgel/vulkan/shaders/vulkanTest1.frag.spv")
                )),
                TypedPointer64.of(null),
        ...
        vkInstance.vkCreateShaderModule(
                ...
                TypedPointer64.of(createShaderModuleInfo(
                        vertShaderInfo,
                        BufferUtils::createAligned,
                        getClass().getResourceAsStream("/de/linusdev/ljgel/vulkan/shaders/vulkanTest1.vert.spv")
                )),
                TypedPointer64.of(null),
        ...
        vkClearValue.color.float32.get(3).set(1.0f);
