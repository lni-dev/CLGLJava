...
import de.linusdev.ljgel.engine.vk.descriptor.pool.DescriptorSet;
...
import de.linusdev.ljgel.engine.vk.memory.buffer.vertex.SimpleVertex;
...
import de.linusdev.ljgel.engine.vk.pipeline.RasterizationPipelineInfo;
...
import de.linusdev.ljgel.nat.vulkan.handles.VkShaderModule;
import de.linusdev.ljgel.nat.vulkan.structs.VkClearValue;
import de.linusdev.ljgel.nat.vulkan.structs.VkCommandBufferBeginInfo;
import de.linusdev.ljgel.nat.vulkan.structs.VkRenderPassBeginInfo;
            ...
            return new RasterizationPipelineInfo() {
                ...
                public @NotNull VulkanShader loadVertexShader() throws IOException {
                    return VulkanShader.createFromSpirVBinaryStream(
                            stack,
                            engine,
                            Objects.requireNonNull(this.getClass().getResourceAsStream("/de/linusdev/ljgel/vulkan/shaders/vulkanTest3.vert.spv")),
                            "main",
                ...
                public @NotNull VulkanShader loadFragmentShader() throws IOException {
                    return VulkanShader.createFromSpirVBinaryStream(
                            stack,
                            engine,
                            Objects.requireNonNull(this.getClass().getResourceAsStream("/de/linusdev/ljgel/vulkan/shaders/vulkanTest3.frag.spv")),
                            "main",
                            Structure.allocate(new VkShaderModule())
                    );
                }
