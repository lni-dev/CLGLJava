...
#include "de_linusdev_ljgel_nat_glad_Glad.h"
#include "glad/gl.h"
 ...
 * Signature: ()I
 */
JNIEXPORT jint JNICALL Java_de_linusdev_ljgel_nat_glad_Glad__1gladLoadGL
 ...
 * Signature: (I)V
 */
JNIEXPORT void JNICALL Java_de_linusdev_ljgel_nat_glad_Glad_glClear
 ...
 * Signature: (FFFF)V
 */
JNIEXPORT void JNICALL Java_de_linusdev_ljgel_nat_glad_Glad_glClearColor
 ...
 * Signature: ()V
 */
JNIEXPORT void JNICALL Java_de_linusdev_ljgel_nat_glad_Glad_glFinish
  (JNIEnv* env, jclass clazz) {
    glFinish();
}
 ...
 * Signature: (II)V
 */
JNIEXPORT void JNICALL Java_de_linusdev_ljgel_nat_glad_Glad_glBindFramebuffer
 ...
 */
JNIEXPORT void JNICALL Java_de_linusdev_ljgel_nat_glad_Glad__1glGenFramebuffers
 ...
 * Signature: ()I
 */
JNIEXPORT jint JNICALL Java_de_linusdev_ljgel_nat_glad_Glad_glGenFramebuffer
        (JNIEnv* env, jclass clazz) {
    jint f;
 ...
 * Signature: ()I
 */
JNIEXPORT jint JNICALL Java_de_linusdev_ljgel_nat_glad_Glad_glCreateFramebuffer
        (JNIEnv *, jclass) {
    jint f;
 ...
 * Signature: (ILjava/nio/ByteBuffer;)V
 */
JNIEXPORT void JNICALL Java_de_linusdev_ljgel_nat_glad_Glad__1glDeleteFramebuffers
 ...
 * Signature: (I)V
 */
JNIEXPORT void JNICALL Java_de_linusdev_ljgel_nat_glad_Glad_glDeleteFramebuffer
 ...
 * Signature: (IIII)V
 */
JNIEXPORT void JNICALL Java_de_linusdev_ljgel_nat_glad_Glad_glNamedFramebufferRenderbuffer
 ...
 * Signature: (ILjava/nio/ByteBuffer;)V
 */
JNIEXPORT void JNICALL Java_de_linusdev_ljgel_nat_glad_Glad__1glGenRenderbuffers
 ...
 * Signature: ()I
 */
JNIEXPORT jint JNICALL Java_de_linusdev_ljgel_nat_glad_Glad_glGenRenderbuffer
        (JNIEnv *, jclass) {
    jint r;
 ...
 * Signature: ()I
 */
JNIEXPORT jint JNICALL Java_de_linusdev_ljgel_nat_glad_Glad_glCreateRenderbuffer
        (JNIEnv *, jclass) {
    jint r;
 ...
 * Signature: (ILjava/nio/ByteBuffer;)V
 */
JNIEXPORT void JNICALL Java_de_linusdev_ljgel_nat_glad_Glad__1glDeleteRenderbuffers
        (JNIEnv* env, jclass clazz, jint n, jobject p_renderbuffers) {
    void* renderbuffers = env->GetDirectBufferAddress(p_renderbuffers);
 ...
 * Signature: (I)V
 */
JNIEXPORT void JNICALL Java_de_linusdev_ljgel_nat_glad_Glad_glDeleteRenderbuffer
 ...
 * Signature: (IIII)V
 */
JNIEXPORT void JNICALL Java_de_linusdev_ljgel_nat_glad_Glad_glNamedRenderbufferStorage
 ...
 */
JNIEXPORT void JNICALL Java_de_linusdev_ljgel_nat_glad_Glad_glBlitNamedFramebuffer(JNIEnv* env, jclass clazz,
 ...
 * Signature: (II)V
 */
JNIEXPORT void JNICALL Java_de_linusdev_ljgel_nat_glad_Glad_glNamedFramebufferReadBuffer
 ...
 * Signature: (II)V
 */
JNIEXPORT void JNICALL Java_de_linusdev_ljgel_nat_glad_Glad_glNamedFramebufferDrawBuffer
 ...
 */
JNIEXPORT jstring JNICALL Java_de_linusdev_ljgel_nat_glad_Glad_glGetString
 ...
 * Signature: (I)V
 */
JNIEXPORT void JNICALL Java_de_linusdev_ljgel_nat_glad_Glad_glEnable
 ...
 * Signature: (I)V
 */
JNIEXPORT void JNICALL Java_de_linusdev_ljgel_nat_glad_Glad_glDisable
        (JNIEnv* env, jclass clazz, jint cap) {
    glDisable(cap);
}
 ...
 */
JNIEXPORT void JNICALL Java_de_linusdev_ljgel_nat_glad_Glad_glDebugMessageCallback
...
JNIEXPORT void JNICALL Java_de_linusdev_ljgel_nat_glad_Glad__1glGenVertexArrays(
...
JNIEXPORT void JNICALL Java_de_linusdev_ljgel_nat_glad_Glad__1glDeleteVertexArrays(
        JNIEnv* env, jclass clazz, jint n, jlong p_arrays
) {
    glDeleteVertexArrays(n, reinterpret_cast<const GLuint*>(p_arrays));
}

JNIEXPORT void JNICALL Java_de_linusdev_ljgel_nat_glad_Glad_glBindVertexArray(
 ...
 * Signature: (IJ)V
 */
JNIEXPORT void JNICALL Java_de_linusdev_ljgel_nat_glad_Glad__1glGenBuffers(
 ...
 * Signature: (IJ)V
 */
JNIEXPORT void JNICALL Java_de_linusdev_ljgel_nat_glad_Glad__1glDeleteBuffers(
        JNIEnv* env, jclass clazz, jint n, jlong p_buffers
) {
