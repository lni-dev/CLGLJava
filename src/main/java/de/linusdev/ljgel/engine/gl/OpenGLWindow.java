...
package de.linusdev.ljgel.engine.gl;

import de.linusdev.ljgel.nat.glad.GladInitException;
import de.linusdev.ljgel.nat.glad.custom.DebugMessageCallback;
...
import static de.linusdev.ljgel.nat.glad.GLConstants.GL_DEBUG_OUTPUT;
import static de.linusdev.ljgel.nat.glad.GLConstants.GL_DEBUG_OUTPUT_SYNCHRONOUS;
