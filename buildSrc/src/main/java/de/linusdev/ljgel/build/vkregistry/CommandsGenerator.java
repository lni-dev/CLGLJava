...
import de.linusdev.ljgel.build.vkregistry.types.CTypes;
...
import static de.linusdev.ljgel.build.vkregistry.ClassesOfMainProject.*;
import static de.linusdev.ljgel.build.vkregistry.RegistryLoader.*;
    ...
    public void generate(
        ...
        for (Command cmd : commands.values()) {
            ...
            if(returnType == CTypes.VOID) {
                ...
                returnClass = RETURNED_VK_RESULT_CLASS;
